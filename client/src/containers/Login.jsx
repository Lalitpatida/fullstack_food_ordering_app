...
//actions => like setuser getuser 


//reducer => to perform those actions


//store => globalized store which basically store all the needs


//dispatch => each and every actions needs to be dispatch
...
const signInWithEmailAndPass = async()=>{
  ...
  return (
   ...
   {/* content Box*/}
   <div className="flex flex-col items-center bg-lime-200 w-[80%] md:w-96 h-full z-10 backdrop-blur-md p-4 px-4 py-12 gap-6">
 
 {/*Top logo section*/}
   <div className='flex items-center justify-start gap-4 w-full '>
    <img src={Logo} className='w-8' alt=''/>  
    <p className="text-headingColor font-semibold text-2xl">FoodRider</p>
     </div>
...
{isSignUp && (
      ...
      {!isSignUp ? 
      <p>
        Doesn't have an account: <motion.button 
          {...buttonClick} className="text-rose-400 underline cursor-pointer bg-transparent"
