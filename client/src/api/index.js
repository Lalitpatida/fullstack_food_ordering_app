...
export const baseURL="http://localhost:5001/food-ordering-app-fullstack/us-central1/app";
...
export const increaseItemQuantity = async (user_id,productId ,type) => {
    ...
    try{
        const res= await axios.post(`/${baseURL}/api/products/updateCart/${user_id}`,
        null,
