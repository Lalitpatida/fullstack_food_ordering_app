...
<div className=" w-full bg-card p-40 backdrop-blur-md h-370 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
  {isLoading ? (
...
<motion.button onClick={submitNewData}
{...buttonClick}
className=" w-9/12 py-2 rounded-md bg-red-400 text-primary hover:bg-red-500 cursor-pointer">Save
</motion.button>
...
export const  InputValurField=({type, placeHolder,stateValue,stateFunc}) =>{
return (
<>
<input type={type}
