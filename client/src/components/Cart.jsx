...
import { baseURL, getAllCartItems, getAllProducts, increaseItemQuantity } from '../api';
...
axios.post(`${baseURL}/api/products/create-checkout-session`,{data}).then((res) =>{
 ...
 <div className=" w-full flex items-center justify-between py-4 pb-12 px-24">
<motion.i {...buttonClick}
  ...
  setItemTotal(data.product_price * data.quantity);
    ...
    return (
        ...
        className=" w-full flex items-center justify-start bg-zinc-800 rounded-md drop-shadow-md px-4 gap-4">
            ...
            className="w-24 min-w-[94px] h-24 object-contain" alt=''/>
